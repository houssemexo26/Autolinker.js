...
describe('isControlChar()', () => {
    it(`should appropriately return true/false to match the regular expression /[\\x00-\\x1F\\x7F]/`, () => {
        for (let charCode = 0; charCode < 65535; charCode++) {
            ...
            const fnResult = isControlChar(charCode);
            const regExpResult = /[\x00-\x1F\x7F]/.test(char);
...
describe('isUrlSuffixAllowedSpecialChar()', () => {
    it(`should appropriately return true/false to match the regular expression /[-+&@#/%=~_()|'$*[\\]{}\\u2713]/`, () => {
        for (let charCode = 0; charCode < 65535; charCode++) {
            const char = String.fromCharCode(charCode);
            const fnResult = isUrlSuffixAllowedSpecialChar(charCode);
            const regExpResult = /[-+&@#/%=~_()|'$*[\]{}\u2713]/.test(char);
...
describe('isUrlSuffixNotAllowedAsFinalChar()', () => {
    it(`should appropriately return true/false to match the regular expression /[?!:,.;^]/`, () => {
        for (let charCode = 0; charCode < 65535; charCode++) {
            const char = String.fromCharCode(charCode);
